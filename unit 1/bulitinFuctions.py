...
print('Jordan')
print('123123123')
print('Michael Jeffery Jordan')

# input() function - this is a built-in fuction that allows
...
number = input('Give me a number and Ill and 470 to it:')

print(int (number)+ 470)